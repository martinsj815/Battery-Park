...
app.layout = html.Div([
    ...
    dcc.Tabs(id='Options', value='tab-1', children=[
        ...
        dcc.Tab(label='Parameters & Performance', value='PP', style={'font-size':'25px', 'border-style':'solid', 'border-radius':'6px'}),
                    ...
                    dbc.Row([
                        dbc.Col([
                         ...
                         html.H5(('- Cells can be constructed in many different forms. These include button/coin-type, cylindrical, prismatic, and pouch-type.'), 
                                 style={'textAlign':'justify', 'margin-left':'20px'}),
                         html.H5(('- Coin cells are most commonly used in academic research and for the small consumer applications such as watches and calculators. The electrodes divided by the separator are sealed inside the can with its top and bottom electrically isolated by the gasket.'), 
                                 style={'textAlign':'justify', 'margin-left':'20px'}),
                         html.H5(('- '), 
                                 style={'textAlign':'justify', 'margin-left':'20px'}),
                        ], width={"size": 8}),
