             ...
             dcc.Tabs(id="P or M", value='tab-1', children=[
                ...
                dbc.Row([
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            html.Div(('- OCV and SOC are important parameters in battery characterization.'), style={'textAlign':'justify','margin-left':'20px', 'font-size':'16px'}),
                            html.Div(('- OCV represents the potential difference between the cathode and anode when no current or voltage is applied. Theoretically, assuming that all active electrode particles are fully connected by conductive additives and maintain electrical neutrality, the OCV can be calculated from the difference in Gibbs free energy between cathode and anode materials.'), style={'textAlign':'justify','margin-left':'20px', 'font-size':'16px'}),
                            ...
                            html.Div(('- OCV is used as an important metric to analyze electrode health and identify potential issues such as internal resistance, and capacity fade by measuring deviations from the OCV.'), style={'textAlign':'justify','margin-left':'20px','margin-top':'10px', 'font-size':'16px'}),
                            html.Div(('- SOC represents the remaining capacity available in the battery at any given point in time. It is expressed as a percentage, where 100% indicates the battery is fully charged, and 0% indicates that it is complete discharge.'), style={'textAlign':'justify','margin-left':'20px', 'font-size':'16px'}),
                            html.Div(('- Since the (electro-)chemical potential of the cathode and anode varies with state of charge, OCV depends on SOC.'), style={'textAlign':'justify','margin-left':'20px', 'font-size':'16px'}),
                            html.Div(('- OCV and SOC are used for battery health assessment, quality control, and aging monitoring.'), style={'textAlign':'justify','margin-left':'20px', 'font-size':'16px'}),
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                         html.Div(("- Voltage represents the difference in potential between the cathode and anode and the driving force of current flowing. The unit is volt [V]."),style={'textAlign':'justify', 'margin-left':'20px', 'font-size':'16px'}), 
                         html.Div(("- When a circuit is connected or current begins to flow, the voltage drops, which is caused by electrode polarization due to the kinetic limits of the reaction and other electrochemical kinetical reactions to allow current to flow during the charge/discharge reaction. The degree of this polarization can be estimated from the voltage deviation (overpotential, \u03B7) from the open circuit voltage. The overpotential is given by"), 
                                 style={'textAlign':'justify', 'margin-left':'20px', 'margin-bottom':'20px', 'font-size':'16px'}),
                        ...
                        html.Div(("During the reaction, the cell involves a series of physical, chemical, and electrochemical steps, including charge-transfer and charge transport reactions."),style={'textAlign':'justify', 'margin-left':'40px', 'margin-bottom':'10px', 'font-size':'16px'}),
                        html.Div(["- The main sources of polarization can be categroized into three parts: 1) ohmic polarization (R",html.Sub("O"),"), 2) activation polarization (R",html.Sub("CT"),"), and 3) concentration polarization (R",html.Sub("P"),")."],style={'textAlign':'left', 'margin-left':'20px', 'margin-bottom':'10px', 'font-size':'16px'}), 
                        dcc.Markdown(dangerously_allow_html=True, mathjax=True, children=('$$R_{total}=R_{o}+R_{ct}+R_{p}$$'), style={'text-align':'center', 'margin-bottom':'20px', 'font-size':'120%'}),
                         ...
                         html.Div((["1) Ohmic Polarization (R",html.Sub("o"), ") arises from the resistance of connectivity's of individual cell components and contact between the cell components. Ohmic polarization appears instantaneously (\u2264 10",html.Sup("-6"),"s) when current flows."]), 
                                 style={'textAlign':'justify', 'margin-left':'40px', 'margin-bottom':'10px', 'font-size':'16px'}),
                    ...
                    ],style={'marginTop': '20px',"margin-bottom":'20px', "margin-right":"20px"},
                    ),],
                ...
                dbc.Row([
                    dbc.Col([
                      ...
                      dbc.Row([
                          ...
                          dbc.Col([
                           html.Div('- Energy stored in the cell is defined as the Capacity multiplied by Voltage and its unit is Wh and can be described as:', style={'textAlign':'justify','font-size':'16px'}),
                           ...
                           html.Div('- Power is the rate at which how fast the energy can be delivered. Its unit is in Watts. Instantaneous power is simply Current times Voltage at the certain time during battery operation. Average power is defined as:', style={'textAlign':'justify','font-size':'16px'}),
