        ...
        dbc.Row([
                dbc.Col([
                    dbc.Row([
                        html.Br(),
                        html.Br(),
                        html.Div(html.Img(src='https://www.dropbox.com/scl/fi/dim0hgfsqwu3trcur7kh5/cylindrical-spir.png?rlkey=qc3763gpj5y85fbgqnualbh7t&st=ti15vzah&raw=1', style={"width":"120%", "margin-bottom":"20px"})), 
                        html.Br(),
                        html.Br(),
                        ],
