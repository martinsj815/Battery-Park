...
layout = html.Div([
                    ...
                    dbc.Row([                        
                        dbc.Col([
                        html.Img(src='https://dl.dropboxusercontent.com/scl/fi/mnfhk96vozvp0veahzl83/CCCV.png?rlkey=j03bhamgmu41fmygfir5bw8ff&st=12w7sd7b&raw=1', 
                                style={"width":"80%", "display": "block", 'margin-left':'30px'}),  
                        ],
                        width={"size": 4},
                            xs=5, sm=10, md=10, lg=10, xl=4,
                        ),
                        dbc.Col([
                         dcc.Markdown(('- **Capacity Test:** Capacity basically represents the amount of electric charge stored in a cell and is one of the key parameters in Li-ion batteries. Hence, measuring its decay over the cell life is important. For charge, CC-CV (constant current – constant voltage) profile is used – constant current used until a voltage limit is reached and constant voltage is applied until current becomes negligible. For discharge, constant current (galvanostatic) is most common due to its easy interpretability and repeatability. A range of C-rates at various temperatures needs to be carefully considered for performance evaluation.'), dangerously_allow_html=True,
                                 style={'textAlign':'justify', 'margin-top':'0px', 'font-size':'16px'}),
                        ],
                        width={"size": 7},
                            xs=5, sm=10, md=10, lg=10, xl=7,                        
                        ),
                    ], style={'margin-bottom':'30px'}
                    ),
                    dbc.Row([                        
                        dbc.Col([
                        html.Img(src='https://dl.dropboxusercontent.com/scl/fi/pkok1beky5c1zyms7oj9k/gitt_mod.png?rlkey=20yio4dtzrphtryu52kfdb2pr&st=zdk5kq1w&raw=1', 
                                style={"width":"80%", "display": "block", 'margin-left':'30px'}),  
                        ],
                        width={"size": 4},
                            xs=5, sm=10, md=10, lg=10, xl=4,
                    ...
                    dbc.Row([                        
                        dbc.Col([
                        html.Img(src='https://dl.dropboxusercontent.com/scl/fi/n32gbcioobl9b7t2cykqh/pseudoOCV.png?rlkey=34v6p8ij6sualjgtl29g9r8m6&st=g6aykazi&raw=1', 
                                style={"width":"80%", "display": "block", 'margin-left':'30px'}),  
                        ],
                        width={"size": 4},
                            xs=5, sm=10, md=10, lg=10, xl=4,
                    ...
                    dbc.Row([                        
                        dbc.Col([
                        html.Img(src='https://dl.dropboxusercontent.com/scl/fi/m2zwxsaxocipsdeqmlvkd/EVS.png?rlkey=cmwv6sc33m0x4mbvxu9i44u6d&st=fqn9ftpu&raw=1', 
                    ...
                    dbc.Row([                        
                        dbc.Col([
                        html.Img(src='https://dl.dropboxusercontent.com/scl/fi/442o07rz7p54217gkyzb2/pulse-power.png?rlkey=16w3qjtzygg4xk9ftrbg18tpy&st=0pnxq7jv&raw=1', 
                                style={"width":"80%", "display": "block", 'margin-left':'30px'}),  
                        ],
                        width={"size": 4},
                            xs=5, sm=10, md=10, lg=10, xl=4,
                    ...
                    dbc.Row([                        
                        dbc.Col([
                        html.Img(src='https://dl.dropboxusercontent.com/scl/fi/yrtaa71tz70wopwzkho9q/EIS.png?rlkey=dqwbedvzmuts00hz6xl8msock&st=p8sc90t4&raw=1', 
                                style={"width":"80%", "display": "block", 'margin-left':'30px'}),  
                        ],
                        width={"size": 4},
                            xs=5, sm=10, md=10, lg=10, xl=4,
                    ...
                    dbc.Row([                        
                        dbc.Col([
                        html.Img(src='https://dl.dropboxusercontent.com/scl/fi/kd9mckvnf9sw3wx7o1xgr/multisine-test.png?rlkey=qxh1h1t2zd4k4mk4p8wlfgcrk&st=ag9tiyr0&raw=1', 
                                style={"width":"80%", "display": "block", 'margin-left':'30px'}),  
                        ],
                        width={"size": 4},
                            xs=5, sm=10, md=10, lg=10, xl=4,
                    ...
                    html.Br(),  
                    dbc.Row([
                        dcc.Markdown('* Cell performance evalution by manufacturers', style={'font-size':'25px', 'margin-bottom':"10px", 'textAlign':'justify','font-weight':'bold'}),
                        dcc.Markdown(('- A list of some of Li ion cell electrochemistry tests commonly performed by the manufacturers is the following:'), dangerously_allow_html=True,
                                 style={'textAlign':'justify', 'margin-left':'30px', 'font-size':'16px'}),  
                        html.Div(('1. Standard Charge (CCCV) / Discharge (CC)'), style={'textAlign':'justify', 'margin-left':'60px', 'margin-bottom':'10px', 'font-size':'16px'}),            
                        html.Div(('2. Cell OCV/DCIR (vs SOC)'), style={'textAlign':'justify', 'margin-left':'60px', 'margin-bottom':'10px', 'font-size':'16px'}),            
                        html.Div(('3. Capacity Retention Test (Cell Cycle Life)'), style={'textAlign':'justify', 'margin-left':'60px', 'margin-bottom':'10px', 'font-size':'16px'}),            
                        html.Div(('4. Calendar Life'), style={'textAlign':'justify', 'margin-left':'60px', 'margin-bottom':'10px', 'font-size':'16px'}),            
                        html.Div(('5. Low Temperature Performance'), style={'textAlign':'justify', 'margin-left':'60px', 'margin-bottom':'10px', 'font-size':'16px'}),            
                        html.Div(('6. Energy density/retention vs. C-rates (Power test)'), style={'textAlign':'justify', 'margin-left':'60px', 'margin-bottom':'10px', 'font-size':'16px'}),  
                        html.Div(('7. Safety test:'), style={'textAlign':'justify', 'margin-left':'60px', 'margin-bottom':'20px', 'font-size':'16px'}),   
                        dcc.Markdown(('- Nail Penetration (Voltage/Temperature variation vs Time with the nail geometry, penetration speed and depth specified) - measuring internal short circuit'), dangerously_allow_html=True,
                                 style={'textAlign':'justify', 'margin-left':'70px','font-size':'16px'}),                 
                        dcc.Markdown(('- Overcharge (Temperature change upon charge to much higher voltage than designed) '), dangerously_allow_html=True,
                                 style={'textAlign':'justify', 'margin-left':'70px', 'font-size':'16px'}),        
                        dcc.Markdown(('- Thermal stability (Fully charged cell measured at the incremental temperature plateaus until a thermal runway or gradual/sudden voltage drop detected.) '), dangerously_allow_html=True,
                                 style={'textAlign':'justify', 'margin-left':'70px', 'font-size':'16px'}),  
                        dcc.Markdown(('- External short circuit (Current/Voltage/Temperature variation with time in a low resistance environment.) '), dangerously_allow_html=True,
                                 style={'textAlign':'justify', 'margin-left':'70px', 'font-size':'16px'}),                          
                        ], style={'textAlign':'justify', 'margin-left':'40px', 'margin-right':'60px'},
                        ),
                    html.Br(),               
