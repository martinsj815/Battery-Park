...
#dash.register_page(__name__, name="basics", top_nav=True, path="/basics")

dash.register_page(__name__, name="basics", top_nav=True)
...
#@callback(Output('Options-content', 'children'), Input('Options','value'))


from dash.exceptions import PreventUpdate

# Add this line below your callback function
@callback(
